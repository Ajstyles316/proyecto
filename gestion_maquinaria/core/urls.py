...
urlpatterns = [
    ...
    path('usuarios/reset/solicitar/', SolicitarResetPasswordView.as_view()),
    path('usuarios/reset/verificar/', VerificarCodigoResetPasswordView.as_view()),
    path('usuarios/reset/reenviar/', ReenviarCodigoResetPasswordView.as_view()),
