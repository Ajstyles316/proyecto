...
const NovedadesPage = lazy(() => import("../views/dashboard/components/Novedades/NovedadesMain"));
...
const Router = [
  {
    ...
    children: [
      ...
      { path: "/novedades", element: <PrivateRoute><NovedadesPage maquinariaId={null} maquinariaPlaca={""} /></PrivateRoute> },
