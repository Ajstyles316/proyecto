...
export const mantenimientoFields = [
  ...
  { key: 'consumo_combustible', label: 'Consumo de Combustible (Lts)' },
  { key: 'consumo_lubricantes', label: 'Consumo de Lubricantes (Lts)' },
  { key: 'mano_obra', label: 'Mano de Obra ($)' },
  { key: 'tecnico_responsable', label: 'Técnico Responsable' },
];
