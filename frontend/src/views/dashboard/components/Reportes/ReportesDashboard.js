        ...
        <Grid item xs={12}>
          <Paper sx={{ p: 3, borderRadius: 3, boxShadow: 2 }}>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
              <Chip
                label={`Control: ${dashboardData.resumen.control}`}
                color={dashboardData.resumen.control > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`Asignación: ${dashboardData.resumen.asignacion}`}
                color={dashboardData.resumen.asignacion > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`Mantenimiento: ${dashboardData.resumen.mantenimiento}`}
                color={dashboardData.resumen.mantenimiento > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`SOAT: ${dashboardData.resumen.soat}`}
                color={dashboardData.resumen.soat > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`Seguros: ${dashboardData.resumen.seguros}`}
                color={dashboardData.resumen.seguros > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`ITV: ${dashboardData.resumen.itv}`}
                color={dashboardData.resumen.itv > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`Impuestos: ${dashboardData.resumen.impuestos}`}
                color={dashboardData.resumen.impuestos > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`Depreciaciones: ${dashboardData.resumen.depreciaciones}`}
                color={dashboardData.resumen.depreciaciones > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
              <Chip
                label={`Pronósticos: ${dashboardData.resumen.pronosticos}`}
                color={dashboardData.resumen.pronosticos > 0 ? 'success' : 'default'}
                variant="outlined"
                sx={{ fontSize: '0.9rem', '& .MuiChip-label': { px: 2 } }}
              />
            </Box>
